            ...
            <FadeIn timeout={1000}>
              <Grid item xs={12}>
                <div className={classes.topDiv}>
                  <Typography
                    classes={{ root: classes.topHeading }}
                    variant="h4"
                  >
                    WHAT DEFINES US
                  </Typography>
              ...
              <Grid item xs={12} md>
                <div className={classes.typoDiv}>
                  ...
                  <Typography variant="body1">
                    ...
                    providing easy to use, functional products you’ll want to
                    use every single day.The company was founded with the
                    purpose of providing high quality products with an
                    affordable price tag, but without ever compromising on
                    ethics.
                  </Typography>
                </div>
              </Grid>
